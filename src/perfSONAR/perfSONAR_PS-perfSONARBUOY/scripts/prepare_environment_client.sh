...
$MAKEROOT ln -s /tmp/BUOY/scripts/perfsonarbuoy_owp_master /etc/init.d/perfsonarbuoy_owp_master
$MAKEROOT ln -s /tmp/BUOY/scripts/perfsonarbuoy_bw_master /etc/init.d/perfsonarbuoy_bw_master
...
$MAKEROOT rm -f /tmp/BUOY/scripts/prepare_environment_client.sh
